...
internal class ErrorPresenter {
    ...
    private let queue = DispatchQueue(label: "com.whisp.errorpresenter", qos: .userInitiated)
    ...
    private let logger = Logger(subsystem: "com.whisp.app", category: "ErrorPresenter")
