...
/// Centralized localized strings for Whisp
internal enum LocalizedStrings {
    ...
    enum UI {
        ...
        static let microphoneAccessRequired = NSLocalizedString(
            "ui.microphone_access_required",
            value: "Mic access needed",
            comment: "Status when microphone permission is denied")

        static let spaceToRecord = NSLocalizedString(
            "ui.space_to_record",
    ...
    enum Alerts {
        ...
        static let microphoneAccessTitle = NSLocalizedString(
            "alerts.microphone_access_title",
            value: "Microphone Access Required",
            comment: "Title for microphone permission alert")

        static let microphoneAccessMessage = NSLocalizedString(
            "alerts.microphone_access_message",
            value:
                "Whisp needs microphone access to record audio. Please enable microphone access in System Settings > Privacy & Security > Microphone.",
            comment: "Message explaining why microphone access is needed")

        static let openSystemSettings = NSLocalizedString(
            "alerts.open_system_settings",
    ...
    // MARK: - Errors
    enum Errors {
        static let failedToStartRecording = NSLocalizedString(
            "errors.failed_to_start_recording",
        ...
        static let failedToGetRecordingURL = NSLocalizedString(
            "errors.failed_to_get_recording_url",
            value: "Unable to save your recording. Please try recording again.",
            comment: "Error when recording URL is unavailable")

        static let recordingURLEmpty = NSLocalizedString(
            "errors.recording_url_empty",
        ...
        static let localTranscriptionFailed = NSLocalizedString(
            "errors.local_transcription_failed",
            value:
        ...
        static let invalidAudioFile = NSLocalizedString(
            "errors.invalid_audio_file",
        ...
        static let fileUploadFailed = NSLocalizedString(
    ...
    enum LocalWhisper {
        static let modelNotDownloaded = NSLocalizedString(
            "local_whisper.model_not_downloaded",
            value:
                "The selected model hasn't been downloaded yet. Please wait for it to finish downloading or choose a different model.",
            comment: "Error when whisper model is not available")

        static let invalidAudioFormat = NSLocalizedString(
            "local_whisper.invalid_audio_format",
            value: "This audio format isn't supported. Please try recording again.",
            comment: "Error when audio format is not supported")

        static let failedToAllocateBuffer = NSLocalizedString(
            "local_whisper.failed_to_allocate_buffer",
        ...
        static let noAudioChannelData = NSLocalizedString(
            "local_whisper.no_audio_channel_data",
            value: "No audio was detected in your recording. Please try recording again.",
            comment: "Error when audio has no channel data")

        static let failedToResampleAudio = NSLocalizedString(
            "local_whisper.failed_to_resample_audio",
    ...
    enum Menu {
        ...
        static let closeWindow = NSLocalizedString(
            "menu.close_window",
            value: "Close Window",
    ...
    enum Settings {
        static let title = NSLocalizedString(
            "settings.title",
            value: "Whisp Settings",
            comment: "Settings window title")
    }

    // MARK: - Accessibility
    enum Accessibility {
        static let microphoneIcon = NSLocalizedString(
            "accessibility.microphone_icon",
            value: "Whisp",
            comment: "Accessibility description for microphone icon")

        static let recordingButton = NSLocalizedString(
            "accessibility.recording_button",
            value: "Recording button",
            comment: "Accessibility description for main recording button")

        static let progressIndicator = NSLocalizedString(
            "accessibility.progress_indicator",
            value: "Download progress",
            comment: "Accessibility label for download progress indicators")

        static let modelDownloadStatus = NSLocalizedString(
            "accessibility.model_download_status",
